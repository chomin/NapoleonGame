...
public class CardTest extends TestCase {
 // すべてのテストメソッドで用いるカードのインスタンス
     ...
     * isAnnorのテスト
     */
    public void testIsAnnor() {
        assertEquals(true, spadeA.isAnnor());
        assertEquals(true, diamond10.isAnnor());
        assertEquals(true, heartQ.isAnnor());
        assertEquals(true, clubK.isAnnor());
        assertEquals(false, spade5.isAnnor());
        assertEquals(true, diamondA.isAnnor());
        assertEquals(true, heartA.isAnnor());
        assertEquals(true, clubA.isAnnor());
        assertEquals(false, joker.isAnnor());
    }
